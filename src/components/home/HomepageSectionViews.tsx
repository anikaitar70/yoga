...
export function PhilosophySectionView({ philosophy }: { philosophy: HomepagePhilosophy }) {
  const sutras = philosophy.sutras ?? [];

  return (
    <SectionLayoutShell sectionType="CUSTOM_TEXT" border="subtle" variant="warm">
      <Container>
...
export function PathwayPreviewSection({ pathway }: { pathway: ProgramPathway }) {
  return <ProgramPathwaySection pathway={pathway} />;
}
...
export function FeaturedEventsSectionView({
  ...
  return (
    <SectionLayoutShell sectionType="EVENTS" border="subtle">
      <Container>
        <ScrollReveal animation="rise">
...
export function RetreatsPreviewSectionView({
  ...
  return (
    <SectionLayoutShell sectionType="EVENTS" border="subtle" variant="immersive">
      <Container>
        <ScrollReveal animation="rise">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <SectionHeading
...
export function GalleryPreviewSection({
  ...
  return <HomeGallerySection items={items} chrome={chrome} />;
}
...
export function TestimonialsSectionView({
  ...
  return (
    <SectionLayoutShell sectionType="TESTIMONIALS" border="subtle" variant="immersive">
      <Container>
        <ScrollReveal animation="rise">
          <SectionHeading
            eyebrow={chrome.eyebrow}
...
export function NewsletterSectionView({
  ...
  return (
    <SectionLayoutShell sectionType="CUSTOM_TEXT" border="subtle" variant="card">
      <Container>
        <ScrollReveal animation="rise">
...
export function ContactPreviewSectionView({
  ...
  return (
    <SectionLayoutShell sectionType="CONTACT" border="none" variant="warm">
      <Container>
        <ScrollReveal animation="rise">
