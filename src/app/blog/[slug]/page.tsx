    ...
    <article className="border-b border-border">
      ...
      <PageContent border="bottom">
        <Prose className="mx-auto max-w-2xl">
          <p>
            This is placeholder editorial content for “{post.title}.” Connect your
            CMS or markdown layer when you are ready—routing and SEO shells are
            already in place.
          </p>
          <p>
            For now, the excerpt below expands the same themes as the listing card,
            giving readers a calm reading column without backend wiring.
          </p>
