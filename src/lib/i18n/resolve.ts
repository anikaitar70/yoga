...
export function uiMessage(
  ...
  if (locale === DEFAULT_LOCALE) {
    const EN_UI: Record<UiMessageKey, string> = {
      ...
      expandSpecialEventsAria: "Show all special events",
      collapseSpecialEventsAria: "Show fewer special events",
      expandRegularClassesAria: "Show all regular classes",
      collapseRegularClassesAria: "Show fewer regular classes",
      formName: "Name",
      formEmail: "Email",
      ...
      readMore: "Read more",
      close: "Close",
      closeEventDetail: "Close event details",
